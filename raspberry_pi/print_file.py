#Prints a file with adaptive control turned *off*,
#but still records filament diameter and the command that *would have* been sent
...
parser.add_argument('-f',help='load gcode file')
